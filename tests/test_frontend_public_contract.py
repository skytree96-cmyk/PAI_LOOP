...
def test_static_assets_have_a_deterministic_ui_cache_buster() -> None:
    ...
    assert 'href="./styles.css?v=20260913-top-navigation-v1"' in html
    assert 'href="./top-navigation.css?v=20260913-top-navigation-v1"' in html
    assert 'src="./app.js?v=20260913-top-navigation-v1"' in html
